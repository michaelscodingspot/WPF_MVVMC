...
>NOTE: The NuGet package supports .NET Cor WPF projects. In XAML, you'll have to use the namespace `MVVMC.NetCore` instead of `MVVMC`. Like this: `xmlns:mvvmc="clr-namespace:MVVMC;assembly=MVVMC.NetCore"`
